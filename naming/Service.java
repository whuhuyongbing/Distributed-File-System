...
public interface Service
{
    /** Determines whether a path refers to a directory.
        ...
        @throws RMIException If the call cannot be completed due to a network
                             error.
     */
    boolean isDirectory(Path path) throws RMIException, FileNotFoundException;
    ...
    /** Lists the contents of a directory.
        ...
        @throws RMIException If the call cannot be completed due to a network
                             error.
     */
    String[] list(Path directory) throws RMIException, FileNotFoundException;
    ...
    /** Creates the given file, if it does not exist.
        ...
        @throws RMIException If the call cannot be completed due to a network
                             error.
     */
    boolean createFile(Path file) throws RMIException, FileNotFoundException;
    ...
    /** Creates the given directory, if it does not exist.
        ...
        @throws RMIException If the call cannot be completed due to a network
                             error.
     */
    boolean createDirectory(Path directory) throws RMIException, FileNotFoundException;
    ...
    /** Deletes a file or directory.
        ...
        @throws RMIException If the call cannot be completed due to a network
                             error.
     */
    boolean delete(Path path) throws RMIException, FileNotFoundException;
    ...
    /** Returns a stub for the storage server hosting a file.
        ...
        @throws RMIException If the call cannot be completed due to a network
                             error.
     */
    Storage getStorage(Path file) throws RMIException, FileNotFoundException;
}
